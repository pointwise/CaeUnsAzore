...
*/
#define ID_CaeUnsAzore 440
{
    /*== CAEP_FORMATINFO FormatInfo */
    {   PWP_SITE_GROUPNAME,         /* const char *group */
        "AzoreCFD",             /* const char *name */
        MAKEGUID(ID_CaeUnsAzore),  /* PWP_UINT32 id */
    ...
    CaeUnsAzoreBCInfo,            /* CAEP_BCINFO* */
    ARRAYSIZE(CaeUnsAzoreBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    CaeUnsAzoreVCInfo,            /* CAEP_VCINFO* pVCInfo */
    ARRAYSIZE(CaeUnsAzoreVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsAzoreFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsAzoreFileExt), /* PWP_UINT32 ExtCnt */
